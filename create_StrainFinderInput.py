...
parser.add_argument("--host", help="Name of specific samples to run code on")
...
snp_samples = config.Poyet_samples[host]
...
while final_line_number >= 0:
    ...
    snp_samples, allele_counts_map, passed_sites_map, final_line_number = parse_midas_data.parse_snps(species_name,host,debug=debug, allowed_variant_types=set(['1D','2D','3D','4D']),chunk_size=chunk_size,allowed_samples=snp_samples, initial_line_number=final_line_number, allowed_genes=non_shared_genes, snps_directory=snps_directory)
